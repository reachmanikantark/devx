...
<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    array('controller' => 'users', 'action' => 'login'),array("class"=>'nav-link'));?>
    ...
    array('controller' => 'users', 'action' => 'signup'),array("class"=>'nav-link'));?>
        ...
        <?php if($loginId) { ?>
     <div class="col-md-4 welcome-user">Hi <?php echo $this->Session->read('Auth.User.firstname'). " " .$this->Session->read('Auth.User.lastname');?></div><?php }?>
  </div>
</nav>